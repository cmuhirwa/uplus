...
{	
	...
	if($clientType == 'group'){
		...
		$telephone = $clientData['adminPhone'];
					...
					<tr>
						...
						<td width="15%">
						    <div style="
								...
								<img src="<?php echo $clientImg; ?>" style="width: 176px; height: 176px;float:  right;">
							</div>
						</td>
					</tr>
				</table>
									...
									<div class="uk-width-3-4" style="border-right: 1px solid #eee; padding-right: 5%">
										...
										<table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
											...
											<tbody>
												<?php
													if($clientType == 'group'){
														$transactions = userTransactions($groupId);
													}else{
									...
									<div class="uk-width-1-4">
										<div class="">
											<?php 
												...
												if(strcasecmp($clientType, 'group')==0){
													$members = $Group->members($groupId);
													echo "<h4>Owners(".count($members).")</h4>";
												}else{
													echo "<h4>Owners(1)</h4>";
												}
											?>
	...
	<div class="uk-modal" id="approve_csd_modal" aria-hidden="true" style="display: none; overflow-y: auto;">
		<div class="uk-modal-dialog" style="top: 339.5px;">
			...
			<form id="csdRequest" method="POST" enctype="multipart/form-data">				
				...
				<input type="hidden" id="csdClientId" value="<?php echo $viewid; ?>" data-type="<?php echo $clientType; ?>">
	...
	<div class="uk-modal" id="deny_csd_modal" aria-hidden="true" style="display: none; overflow-y: auto;">
		<div class="uk-modal-dialog" style="top: 339.5px;">
			...
			<form id="denyCSDform" method="POST" enctype="multipart/form-data">				
				...
				<input type="hidden" id="csdClientId" value="<?php echo $viewid; ?>">
				<div class="uk-modal-footer uk-text-right">
					<button class="md-btn md-btn-danger pull-left uk-modal-close">Cancel</button>
